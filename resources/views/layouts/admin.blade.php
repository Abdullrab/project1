          ...
          <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
              ...
              <div class="sidebar-brand">
                  <a href="{{ route('admin.dashboard') }}" class="brand-link">
                      ...
                      <span class="brand-text fw-bold">My Shop</span>
                  </a>
              </div>
              <!--end::Sidebar Brand-->
                          ...
                          <li class="nav-item has-treeview {{ request()->routeIs('admin.products*') ? 'menu-open' : '' }}">
                              ...
                              <ul class="nav nav-treeview ms-3">
                                  ...
                                  <li class="nav-item">
                                   ...
                                   <li class="nav-item">
                                      <a href="{{ route('admin.products.category') }}" class="nav-link {{ request()->routeIs('admin.products.category') ? 'active' : '' }}">
                                          <i class="bi bi-circle nav-icon"></i>
                                          <p>Category</p>
                                      </a>
                                  </li>
